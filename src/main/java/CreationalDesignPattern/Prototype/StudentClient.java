...
//        System.out.println(studentApr23Proto);
        ...
        Student pratyushApr23 = studentRegistry.getPrototype("Apr23").copy();
        pratyushApr23.setName("Pratyush");
        pratyushApr23.setEmail("peatyush@email.com");
        pratyushApr23.setPhoneNumber("1234");
        System.out.println(pratyushApr23);

        Student ananthApr23 = studentRegistry.getPrototype("Mar23").copy();
